...
//-------------------------------------------------------------------
AboutBox::AboutBox()
	: BWindow(BRect(140, 40, 350, 175), "About SlaveMind...", B_TITLED_WINDOW_LOOK,
	B_MODAL_APP_WINDOW_FEEL, B_NOT_ZOOMABLE | B_NOT_CLOSABLE |
	B_NOT_RESIZABLE | B_NOT_MINIMIZABLE)
{
	Info1 = new BStringView(BRect(10,10,340,20), "", "SlaveMind v1.2 for R5");
	AddChild(Info1);
	...
	AddChild(Info5);
	Web = new BButton(BRect(10, 80, 200, 80), "", "SlaveMind Web Page", new BMessage(WEB));
	AddChild(Web);
